...
class programacionForm(FlaskForm):
    ...
    direccion_origen = StringField('Dirección Origen', render_kw={"placeholder": "Dirección Origen", "class": "form-control"}, validators=[Optional()])
    ...
    direccion_destino = StringField('Dirección Destino', render_kw={"placeholder": "Dirección Destino", "class": "form-control"}, validators=[Optional()])
